...
```python
# --- Superset MCP (prod) ---
# Включаем авторизацию. Способ зависит от того, как OpenClaw будет
# аутентифицироваться. Самый простой для внутреннего контура — API key.
MCP_AUTH_ENABLED = True
MCP_API_KEY_ENABLED = True
MCP_RBAC_ENABLED = True          # пусть инструменты уважают права пользователя

# Если OpenClaw и MCP в одной приватной сети и наружу :5008 НЕ торчит,
# можно временно оставить dev-режим — но только при гарантированной изоляции:
