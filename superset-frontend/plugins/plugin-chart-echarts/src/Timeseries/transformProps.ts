...
export default function transformProps(
  ...
  let xAxis: any = {
    ...
    axisTick: { show: !xAxisHideTick },
    axisLine: { show: !xAxisHideLine },
    splitLine: { show: !xAxisHideSplitLine },
    minInterval:
  ...
  let yAxis: any = {
    ...
    splitLine: { show: !isSmallChart && !yAxisHideSplitLine },
    axisLabel: {
      show: !isMicroChart,
    ...
    axisTick: { show: !isSmallChart && !yAxisHideTick },
    axisLine: { show: !yAxisHideLine },
    scale: truncateYAxis,
